...
linkTitle: "Label incoming UNOFFICIAL email"
weight: 005
...
| Description | Applies the UNOFFICIAL label to incoming emails based on either the header or the subject |
...
| Regular expression |              `SEC=UNOFFICIAL` |
