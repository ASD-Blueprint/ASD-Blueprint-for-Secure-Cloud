...
linkTitle: "Label incoming OFFICIAL: Sensitive Legal Privilege email"
weight: 025
...
| Description | Applies the OFFICIAL: Sensitive Legal Privilege label to incoming emails based on either the header or the subject |
...
| Item                |                                      Value |
| ------------------- | -----------------------------------------: |
| Label to auto-apply | OFFICIAL Sensitive (group)/Legal Privilege |
...
| Regular expression | `SEC=OFFICIAL:Sensitive(?!, CAVEAT=).*, ACCESS=Legal-Privilege` |
