...
linkTitle: "Label incoming PROTECTED CABINET Personal Privacy email"
weight: 100
...
| Description | Applies the PROTECTED CABINET Personal Privacy label to incoming emails based on either the header or the subject |
...
| Item                |                                      Value |
| ------------------- | -----------------------------------------: |
| Label to auto-apply | PROTECTED CABINET (group)/Personal Privacy |
...
| Regular expression | `SEC=PROTECTED, CAVEAT=SH:CABINET.*, ACCESS=Personal-Privacy` |
