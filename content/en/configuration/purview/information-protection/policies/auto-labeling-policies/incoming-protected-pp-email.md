...
| Description | Applies the PROTECTED Personal Privacy label to incoming emails based on either the header or the subject |
...
| Item                |                              Value |
| ------------------- | ---------------------------------: |
| Label to auto-apply | PROTECTED (group)/Personal Privacy |
