---
title: "GRANT - Require password change for high-risk users"
weight: 10
type: docs
...
| Item |                                               Value |
| ---- | --------------------------------------------------: |
| Name | GRANT - Require password change for high-risk users |
...
| Item                                                                        |          Value |
| --------------------------------------------------------------------------- | -------------: |
| **User risk**<br>Configure user risk levels needed for policy to be enforced|                |
| High                                                                        |        Checked |
| Medium                                                                      |                |
| Low                                                                         |                |
| No risk                                                                     |                |
