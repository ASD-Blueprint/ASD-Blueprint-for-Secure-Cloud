...
| Item                                            | Value                                                                                                                                                 |
| ----------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| PowerShell script                               | [DisableDomainCreds](</content/files/configscripts/DisableDomainCreds.txt>).ps1 <br> *Note: download the linked .txt file, and rename to .ps1 for upload* |
