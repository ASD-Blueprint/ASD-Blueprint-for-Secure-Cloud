...
| Item                                            | Value                                                                                                                                               |
| ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| PowerShell script                               | [ObCaseInsensitive](</content/files/configscripts/ObCaseInsensitive.txt>).ps1 <br> *Note: download the linked .txt file, and rename to .ps1 for upload* |
