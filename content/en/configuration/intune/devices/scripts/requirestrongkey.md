...
| Item                                            | Value                                                                                                                                             |
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| PowerShell script                               | [RequireStrongKey](</content/files/configscripts/RequireStrongKey.txt>).ps1 <br> *Note: download the linked .txt file, and rename to .ps1 for upload* |
