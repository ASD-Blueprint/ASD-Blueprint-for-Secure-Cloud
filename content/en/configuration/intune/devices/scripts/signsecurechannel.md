...
| Item                                            | Value                                                                                                                                               |
| ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| PowerShell script                               | [SignSecureChannel](</content/files/configscripts/SignSecureChannel.txt>).ps1 <br> *Note: download the linked .txt file, and rename to .ps1 for upload* |
