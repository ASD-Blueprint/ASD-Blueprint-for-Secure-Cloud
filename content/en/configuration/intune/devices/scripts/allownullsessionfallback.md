...
| Item                                            | Value                                                                                                                                                             |
| ----------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| PowerShell script                               | [allownullsessionfallback](</content/files/configscripts/allownullsessionfallback.txt>).ps1 <br> *Note: download the linked .txt file, and rename to .ps1 for upload* |
