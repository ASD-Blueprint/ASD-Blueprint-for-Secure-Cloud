...
| Item                                            | Value                                                                                                                                                   |
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| PowerShell script                               | [LDAPClientIntegrity](</content/files/configscripts/LDAPClientIntegrity.txt>).ps1 <br> *Note: download the linked .txt file, and rename to .ps1 for upload* |
