...
| Item                                            | Value                                                                                                                                                                   |
| ----------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| PowerShell script                               | [SCENoApplyLegacyAuditPolicy](</content/files/configscripts/SCENoApplyLegacyAuditPolicy.txt>).ps1 <br> *Note: download the linked .txt file, and rename to .ps1 for upload* |
