...
| Item                                            | Value                                                                                                                                                 |
| ----------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| PowerShell script                               | [ForceKeyProtection](</content/files/configscripts/ForceKeyProtection.txt>).ps1 <br> *Note: download the linked .txt file, and rename to .ps1 for upload* |
