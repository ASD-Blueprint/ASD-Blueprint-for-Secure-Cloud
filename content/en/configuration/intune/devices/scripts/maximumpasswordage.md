...
| Item                                            | Value                                                                                                                                                 |
| ----------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| PowerShell script                               | [MaximumPasswordAge](</content/files/configscripts/MaximumPasswordAge.txt>).ps1 <br> *Note: download the linked .txt file, and rename to .ps1 for upload* |
