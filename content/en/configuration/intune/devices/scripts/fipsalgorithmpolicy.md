...
| Item                                            | Value                                                                                                                                                   |
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| PowerShell script                               | [FIPSAlgorithmPolicy](</content/files/configscripts/FIPSAlgorithmPolicy.txt>).ps1 <br> *Note: download the linked .txt file, and rename to .ps1 for upload* |
