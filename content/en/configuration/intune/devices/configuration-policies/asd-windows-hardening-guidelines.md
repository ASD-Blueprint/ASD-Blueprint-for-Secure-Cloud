...
Download the {{% download file="/content/files/intune-config-policies/windows-hardening.txt" %}} Windows Hardening Guidelines {{% /download %}} *.txt* file and change the extension to *.json*, then select **Create > Import Policy**.
